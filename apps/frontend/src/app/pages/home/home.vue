...
<template>
    ...
    <div class="col-span-2 card--shadow">
      <div class="card__content">
        <h3 class="text-xs space-y-1">
          ...
          <span class="font-bold block">Asociación <br> Empleados</span>
        </h3>
      </div>
    </div>
      ...
      <div class="card__content space-y-4">
        <div class="flex items-center space-x-4">
          ...
          <div class="text-xs">
            ...
            <span class="block text-dark-4">Jefe de Sistemas Informáticos</span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="card--main">
            <div class="card__content flex flex-col items-center justify-center text-xs space-y-2">
          ...
          <div class="card--main">
            <div class="card__content flex flex-col items-center justify-center text-xs space-y-2">
              ...
              <span class="block font-bold text-center">CH, L-J, 7:30 - 4:30  V, 7:30 - 4:00</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-span-3 card card--shadow">
      <div class="card__content space-y-4">
        <div class="flex items-center space-x-4">
          ...
          <div class="text-xs">
            <span class="block font-bold">Puesto</span>
            <span class="block text-dark-4">Ingeniero Sistemas Informáticos</span>
          </div>
        </div>
  ...
  <div class="mt-8 space-y-10">
    <div class="mx-auto grid grid-cols-6 gap-4">
      ...
      <div class="space-y-2">
        <button class="btn--error btn--small">
          Small
        </button>
        <button
          class="btn--error btn--small"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--info btn--small">
          Small
        </button>
        <button
    ...
    <div class="mx-auto grid grid-cols-6 gap-4">
      <div class="space-y-2">
        <button class="btn--main btn--large">
          Large
        </button>
        <button
      ...
      <div class="space-y-2">
        <button class="btn--error btn--large">
          Large
        </button>
        <button
          class="btn--error btn--large"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--info btn--large">
          Large
        </button>
        <button
  ...
  <div class="mt-8 space-y-10">
    <div class="mx-auto grid grid-cols-6 gap-4">
      <div class="space-y-2">
        ...
        <button
          class="btn--main btn--small btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--error btn--small btn--outline">
          Small
        </button>
        <button
          class="btn--error btn--small btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--warning btn--small btn--outline">
          Small
        </button>
        <button
          class="btn--warning btn--small btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--info btn--small btn--outline">
          Small
        </button>
        <button
          class="btn--info btn--small btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--success btn--small btn--outline">
          Small
        </button>
        <button
          class="btn--success btn--small btn--outline"
          disabled
        >
          Disabled
        </button>
    ...
    <div class="mx-auto grid grid-cols-6 gap-4">
      <div class="space-y-2">
        <button class="btn--main btn--outline">
          Medium
        </button>
        <button
      ...
      <div class="space-y-2">
        <button class="btn--error btn--outline">
          Medium
        </button>
        <button
      ...
      <div class="space-y-2">
        <button class="btn--warning btn--outline">
          Medium
        </button>
        <button
      ...
      <div class="space-y-2">
        <button class="btn--info btn--outline">
          Medium
        </button>
        <button
      ...
      <div class="space-y-2">
        <button class="btn--success btn--outline">
          Medium
        </button>
        <button
    ...
    <div class="mx-auto grid grid-cols-6 gap-4">
      <div class="space-y-2">
        <button class="btn--main btn--large btn--outline">
          Large
        </button>
        <button
          class="btn--main btn--large btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--error btn--large btn--outline">
          Large
        </button>
        <button
          class="btn--error btn--large btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--warning btn--large btn--outline">
          Large
        </button>
        <button
          class="btn--warning btn--large btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--info btn--large btn--outline">
          Large
        </button>
        <button
          class="btn--info btn--large btn--outline"
          disabled
        >
          Disabled
        </button>
      ...
      <div class="space-y-2">
        <button class="btn--success btn--large btn--outline">
          Large
        </button>
        <button
          class="btn--success btn--large btn--outline"
          disabled
        >
          Disabled
        </button>
