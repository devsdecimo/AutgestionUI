<template>
  ...
  <div class="submenu-container">
      <a class="submenu-container__item btn--small" href="/permissions">
          {{ $t('permissions.applicationBtn') }}
      </a>
      <a class="submenu-container__item btn--small btn--outline" href="/permissions/resolutions">
          {{ $t('permissions.resolutionBtn') }}
      </a>
  </div>
  <div class="main-container">
    <!-- titulo -->
    <div class="flex flex-col gap-6">
      <h1 class="general-title hidden md:block">{{ $t('permissions.mainTitle') }}</h1>
        ...
        <div class="card__content grid grid-cols-1 lg:grid-cols-2  xl:grid-cols-4 gap-8">
          <div class="flex flex-col">
            ...
            <select
              ...
              <option selected :value="true">{{ $t('permissions.approved') }}</option>
    ...
    <div class="table-container">
      ...
      <tbody>
        <tr v-for="(row, rowIndex) in tableRows" :key="rowIndex">
          <td class="col-span-4 p-4" :data-label="$t('permissions.applicationNumber')">
          ...
          <td class="col-span-4 p-4" :data-label="$t('permissions.justification')">
            {{ row.justification }}
          </td>
...
const tableRows = ref([
    {applicationNumber: '2318', actionType: 'Lorem Ipsum', register: '26/07/2024', start: '29/07/2024', end: '29/07/2024', time: '00:00', justification: 'Lorem Ipsum', state: 'Aprobado'},
    {applicationNumber: '2318', actionType: 'Lorem Ipsum', register: '26/07/2024', start: '29/07/2024', end: '29/07/2024', time: '00:00', justification: 'Lorem Ipsum', state: 'Aprobado'},
    {applicationNumber: '2318', actionType: 'Lorem Ipsum', register: '26/07/2024', start: '29/07/2024', end: '29/07/2024', time: '00:00', justification: 'Lorem Ipsum', state: 'Aprobado'},
    {applicationNumber: '2318', actionType: 'Lorem Ipsum', register: '26/07/2024', start: '29/07/2024', end: '29/07/2024', time: '00:00', justification: 'Lorem Ipsum', state: 'Aprobado'},
    {applicationNumber: '2318', actionType: 'Lorem Ipsum', register: '26/07/2024', start: '29/07/2024', end: '29/07/2024', time: '00:00', justification: 'Lorem Ipsum', state: 'Aprobado'},
